...
public final class GardenLockOverlay {
    ...
    private static String chooseReminder(Context context,String packageName){return LockStore.nextLockReminder(context,RemoteConfigStore.reminders(context,REMINDERS));}
